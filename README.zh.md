...
VLM 解码层加速 +32-45% — 与 LLM 模式一致。预估解码速度：SmolVLM2 ~38→54 tok/s (+42%)，FastVLM ~22→29 tok/s (+28%)。
...
**已测试 70+ 模型**，涵盖 22 个类别：LLM、VLM、目标检测、实例/语义分割、分类、OCR、人脸识别/修复、超分辨率、零样本、语音识别、TTS、立体深度、视频分割、说话人识别、音频降噪、目标跟踪、关键点检测、QR码检测、背景去除、照片上色等。
