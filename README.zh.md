...
| MobileCLIP2-S4 | CLIP 图像 | 64.94 | **64.34** | +1% |
...
**已测试 90+ 模型**，涵盖 25 个类别：LLM、VLM、目标检测、姿态估计、实例/语义分割、分类、OCR、人脸识别/修复、超分辨率、零样本、CLIP、语音识别、TTS、深度估计、立体深度、视频分割、说话人识别、音频降噪、目标跟踪、关键点检测、QR码检测、背景去除、照片上色等。
