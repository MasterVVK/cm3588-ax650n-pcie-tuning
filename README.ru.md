...
Слои VLM декодера: +32-45% — совпадает с паттерном LLM. Оценка decode: SmolVLM2 ~38→54 tok/s (+42%), FastVLM ~22→29 tok/s (+28%).
