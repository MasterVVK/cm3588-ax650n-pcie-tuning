...
**40+ моделей протестировано** в 13 категориях: LLM (4 размера моделей, от 0.6B до 7B), детекция, сегментация, классификация, OCR, распознавание лиц, super-resolution, zero-shot, распознавание речи, TTS, стерео глубина, видеосегментация и идентификация говорящего.
