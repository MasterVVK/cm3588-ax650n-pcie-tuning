...
**30+ моделей протестировано** в 10 категориях: LLM, детекция, сегментация, классификация, OCR, распознавание лиц, super-resolution, zero-shot, распознавание речи и TTS.
